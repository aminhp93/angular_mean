  ...
  */
  function UserConstructor() {
    ...
    this.index = function(cb) {
      ...
      $http.get('https://api.github.com/users/aminhp93').then(function(data) {
          users = data.data;
          cb(users);
      });
    };
    ...
    */
    this.create = function(newUser, cb) {
      ...
      $http.post('https://api.github.com/users/aminhp93', newUser).then(function(data) {
        console.log('here');
    ...
    this.update = function(fixedUser, _id, cb) {
      ...
      $http.put('https://api.github.com/users/aminhp93/' + _id, fixedUser).then(function(data) {
    ...
    this.show = function(_id, cb) {
      $http.get('https://api.github.com/users/aminhp93/' + _id).then(function(data) {
